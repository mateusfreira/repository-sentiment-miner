...
function _requestData(obj, property, allowObject) {
        ...
        function getData() {
            ...
            request(requestData, function(err, response) {
                ...
                if (nextPage && nextPage.length === 1) {
                    ...
                    return _requestData(obj, property).then(function(childData) {
...
module.exports.getData = function(url, tokens = [], dependencies = []) {
    const result = {
        "data_url": url
    };
